...
class MCPEngine {
    ...
    async validateNodeOperation(args) {
        ...
        return config_validator_1.ConfigValidator.validate(args.nodeType, args.config, node.properties || []);
    }
    ...
    async getNodeForTask(args) {
        return task_templates_1.TaskTemplates.getTaskTemplate(args.task);
    }
