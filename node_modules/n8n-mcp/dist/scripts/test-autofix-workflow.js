...
async function testAutofix() {
    ...
    const previewResult = autoFixer.generateFixes(testWorkflow, validationResult, allFormatIssues, {
        applyFixes: false,
    ...
    for (const threshold of ['high', 'medium', 'low']) {
        const result = autoFixer.generateFixes(testWorkflow, validationResult, allFormatIssues, {
            applyFixes: false,
